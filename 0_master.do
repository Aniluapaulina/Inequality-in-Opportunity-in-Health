...
global use_simulated = 0  // If codex is in use, rely on simulated data
...
if ${use_simulated} == 0 {
	...
	do "${do_files}1_sample_selection.do"
}
else {
    do "${do_files}1_simulate_data.do"
...
* III. Methodology
	* Parametric Analysis 
	do "${do_files}3_meanbased_panel.do" 
	do "${do_files}3_meanbased_panel_ci.do"
	do "${do_files}3_meanbased_shapley.do"
	
	* Semi-Parametric Analysis 
	do "${do_files}4_beyondmean_panel.do" 
	do "${do_files}4_beyondmean_panel_ci.do"
	do "${do_files}4_beyondmean_shapley.do"
